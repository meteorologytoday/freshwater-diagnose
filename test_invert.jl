...
Dataset("output.nc", "c") do ds
    ...
    defVar(ds, "psi_n",  ψ_n,  ("Nzp1", "Nyp1", "Nx"))
    defVar(ds, "Error_psi_abs", ψ_n - ψ, ("Nzp1", "Nyp1", "Nx"))
    defVar(ds, "Error_psi_rto", (ψ_n - ψ) ./ ψ, ("Nzp1", "Nyp1", "Nx"))


    defVar(ds, "Epsi_a", Eψ_a, ("Nzp1", "Nyp1", "Nx"))
    defVar(ds, "Epsi_n", Eψ_n, ("Nzp1", "Nyp1", "Nx"))
    defVar(ds, "Error_Epsi_abs", Eψ_n - Eψ_a, ("Nzp1", "Nyp1", "Nx"))
    defVar(ds, "Error_Epsi_rto", (Eψ_n - Eψ_a) ./ Eψ_a, ("Nzp1", "Nyp1", "Nx"))

    defVar(ds, "dpsidy",  ∂ψ∂y,    ("Nzp1", "Ny", "Nx"))
    defVar(ds, "DIVypsi",  DIVyψ,  ("Nzp1", "Ny", "Nx"))

    defVar(ds, "psi1",   ψ1,    ("Nzp1", "Nyp1", "Nx"))
    defVar(ds, "Q",       Q,    ("Nz", "Ny", "Nx"))
    defVar(ds, "RHS_Q",  RHS_Q,    ("Nzp1", "Nyp1", "Nx"))
